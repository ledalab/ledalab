...
leda2.gui.text_method = uicontrol('Units','normalized','Style','text','Position',[x3b dy+.03*7 .08 .012],'String','Method: ','HorizontalAlignment','left','BackgroundColor',leda2.gui.col.frame1);
